...
public class ItemGroupsData {
	...
	ItemGroup[] craftGroups;
	ItemGroup[] manastoneGroups;
	ItemGroup[] foodGroups;
	ItemGroup[] medicineGroups;
	ItemGroup[] oreGroups;
	...
	void afterUnmarshal(Unmarshaller u, Object parent) {
		...
		craftGroups = new ItemGroup[] { craftMaterials, craftShop, craftBundles, craftRecipes };
		manastoneGroups = new ItemGroup[] { manastonesCommon, manastonesRare };
		foodGroups = new ItemGroup[] { foodCommon, foodRare, foodLegendary };
		medicineGroups = new ItemGroup[] { medicineCommon, medicineRare, medicineLegendary };
		oreGroups = new ItemGroup[] { oresRare, oresLegendary, oresUnique, oresEpic };
	...
	public Collection<IdReward> getManastonesCommon() {
	...
	public Collection<IdReward> getManastonesRare() {
	...
	public Collection<IdReward> getOresRare() {
	...
	public Collection<IdReward> getOresLegendary() {
	...
	public Collection<IdReward> getOresUnique() {
	...
	public Collection<IdReward> getOresEpic() {
	...
	public Collection<IdReward> getGatherRare() {
	...
	public Collection<IdReward> getBossRare() {
	...
	public Collection<IdReward> getBossLegendary() {
	...
	public ItemGroup[] getCraftGroups() {
		return craftGroups;
	}

	public ItemGroup[] getManastoneGroups() {
		return manastoneGroups;
	}

	public ItemGroup[] getFoodGroups() {
		return foodGroups;
	}

	public ItemGroup[] getMedicineGroups() {
		return medicineGroups;
	}

	public ItemGroup[] getOreGroups() {
		return oreGroups;
	}

	public ItemGroup[] getGatherGroups() {
		return gatherGroups;
	}

	public ItemGroup[] getEnchantGroups() {
